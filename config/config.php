...
# Default DB name for this app
	define('DB_NAME', 'moretha3_p2_morethanasandbox_biz'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'nYHrV^G@$V2za!CH1Gh-MKYjkGU7%MNKiMvRr)!B');
	define('TOKEN_SALT', 'nYHrV^G@$V2za!CH1Gh-MKYjkGU7%MNKiMvRr)!B');
